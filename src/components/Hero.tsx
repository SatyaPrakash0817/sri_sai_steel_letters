                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Sri Sai Steel Letters<br />
                                <span className="bg-clip-text text-transparent bg-linear-to-r from-amber-300 to-amber-400">
                                    Precision stainless steel letters & signage
                                </span>
                            </motion.h1>
                            ...
                            >
                                Custom stainless steel lettering, signage and fabrication for
                                commercial and residential projects — polished finishes, expert installation and durable materials.
                            </motion.p>
                            ...
                            >
                                <Link to="/our-works" className="w-full sm:w-auto">
